...
const poems = [
  ...
  createPoem('Dan Beachy-Quick',            'Mnemosyne in Tatters',               '01/26/2021', '10/16/2020', true,   'New'),
  ...
  createPoem('Zachary Schomburg',             'Flushing Michigan',                          '01/26/2021', '11/22/2020', true, 'New',  'zachary-schomburg-2'),
