...
| Filename | line # | TODO
|:------|:------:|:------
| [projects/midst-journal/store/actions.ts](projects/midst-journal/store/actions.ts#L3) | 3 | Type def file
| [projects/midst-journal/store/actions.ts](projects/midst-journal/store/actions.ts#L6) | 6 | Type def file
| [projects/midst-journal/store/actions.ts](projects/midst-journal/store/actions.ts#L19) | 19 | Should be: ThunkResult<void>. Why doesn't it work?
| [projects/midst-journal/store/actions.ts](projects/midst-journal/store/actions.ts#L21) | 21 | Above should be: ThunkResult<void>, then `any` is not needed here
| [projects/midst-journal/store/reducer.ts](projects/midst-journal/store/reducer.ts#L256) | 256 | Should be Action from `../types.ts`
| [projects/midst-journal/store/selectors.ts](projects/midst-journal/store/selectors.ts#L1) | 1 | Find a use for selectors in this project
| [projects/midst-journal/store/types.ts](projects/midst-journal/store/types.ts#L4) | 4 | How to get around putting this in every project??
| [projects/midst-journal/store/types.ts](projects/midst-journal/store/types.ts#L7) | 7 | Move Midst types to common
| [projects/midst-journal/store/types.ts](projects/midst-journal/store/types.ts#L14) | 14 | Move Midst types to common
