...
| Filename | line # | TODO
|:------|:------:|:------
| [projects/zak-widget/functions/get-product-with-restrictions.ts](projects/zak-widget/functions/get-product-with-restrictions.ts#L6) | 6 | Does a mutation occur here?? Maybe just mutate here, since it's an immer draft anyway
