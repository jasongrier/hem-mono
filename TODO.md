...
| Filename | line # | TODO
|:------|:------:|:------
| [bin/tasks/build.js](bin/tasks/build.js#L22) | 22 | Make programmatic bundler work with parcel-manifest's
...
| [projects/zak-widget/index.ts](projects/zak-widget/index.ts#L5) | 5 | Check all console.log's –– seems like you'll find some dead code
