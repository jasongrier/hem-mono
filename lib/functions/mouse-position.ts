function coords(evt: any, el: any, inverted: boolean = false) {
...
function isMouseIn(evt: any, el: HTMLElement, invert: boolean = false) {
...
function mouseTheta(evt: any, el: HTMLElement) { // TODO: Should be sth like <T>(evt: Event<T>, el: T)
  const rect = el.getBoundingClientRect()
